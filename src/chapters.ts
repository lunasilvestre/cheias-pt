...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    alignment: 'right',
    camera: { center: [-25, 35], zoom: 2.8, pitch: 0, bearing: 0 },
    animation: { type: 'flyTo', duration: 2500 },
    layers: [
      { id: 'storm-tracks', opacity: 0, type: 'line' },
      { id: 'storm-track-labels', opacity: 0, type: 'symbol' },
    ],
    legend: [
      { title: 'SST quente', color: '#d73027', type: 'fill' },
      { title: 'SST fria', color: '#4575b4', type: 'fill' },
      { title: 'Rio atmosférico (IVT)', color: '#7b4ea3', type: 'fill' },
      { title: 'Kristin', color: '#ff6464', type: 'line' },
      { title: 'Leonardo', color: '#64b5f6', type: 'line' },
      { title: 'Marta', color: '#ffc864', type: 'line' },
    ],
